...
sfilePath = r'C:\Users\bzhang\Documents\AI\KT\data copy.json'
testfilePath = r'C:\Users\bzhang\Documents\AI\KT\test.json'
date = '2022-05-24'
...
def split():
    with open(sfilePath,'r') as in_json_file:
...
def flattenJSON():
    ...
    for file_path in all_json_files:
        with open(file_path) as input_file:
            ...
            url = 'https://api.us-south.discovery.watson.cloud.ibm.com/instances/5d0181db-0673-4b6b-9c2d-9bfe00f1d771/v2/projects/720c567d-10c4-4276-bfc3-797e8f19b168/collections/a2e9ff7d-2263-dd21-0000-0180b8f0c2f0/documents/' + documentID +'?version=2020-08-30'
            ...
            #   headers=headers, 
            #    data=flatData, 
            #    auth=('apikey', 'y8J9pF1zud0AK5E1-dGLFh-YPc0V_6CbmZGQ96kq_0Zc')
            #)
...
#Export all SK from JSON and use it as document ID
